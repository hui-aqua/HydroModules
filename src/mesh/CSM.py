...
for j in range(NT_frame):
    ...
    # con_in_one_frame_line.append([1+NN+j*(BN+NN)-0,1+NN_frame+j*(NN_frame+1)+number_of_point_one_netting-2])
    # con_in_one_frame_line.append([1+NN+j*(BN+NN)-2,1+NN_frame+j*(NN_frame+1)+number_of_point_one_netting-4])
    # con_in_one_frame_line.append([1+NN+j*(BN+NN)-4,1+NN_frame+j*(NN_frame+1)+number_of_point_one_netting-6])
